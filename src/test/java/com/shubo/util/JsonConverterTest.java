...
public class JsonConverterTest {
    ...
    public void toJsonFile() throws Exception {
        Customer customer = new Customer("bad3", 1000);
    ...
    @Test
    public void toJsonFileWithPath() throws Exception {
        ...
        JsonConverter.toJsonFile(customer, FILE_PATH);
    }
    ...
    public void toJsonString() throws Exception {
        ...
        String jsonStr = JsonConverter.toJsonString(customer);
        assertTrue(jsonStr.contains("Aaron") && jsonStr.contains("orders") && jsonStr.contains("cards"));
    }
